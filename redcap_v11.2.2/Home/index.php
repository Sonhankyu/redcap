...
{			
	...
	if ($sponsorUserCount > 0) 
	{
		print RCView::div(array('class'=>'d-none d-sm-block col-md-12 clearfix', 'style'=>'padding:0;'), 
				RCView::div(array('class'=>'col-md-9 float-left', 'style'=>'padding:0;'), $html) .
				RCView::div(array('class'=>'col-md-3 float-right', 'style'=>'border-left:1px solid #ddd;padding-right:0;font-size:12px;'),
