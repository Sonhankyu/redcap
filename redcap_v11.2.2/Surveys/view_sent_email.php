...
$sql = "select e.*, p.participant_id, p.hash, r.delivery_type as this_delivery_type,
		...
		if (r.static_phone is null, p.participant_phone, r.static_phone) as participant_phone, e.append_survey_link
...
if ($email['this_delivery_type'] == 'EMAIL') {
	...
	$invitation_msg = TwilioRC::cleanSmsText($invitation_msg);
