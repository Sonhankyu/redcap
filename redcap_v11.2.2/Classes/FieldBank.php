...
class FieldBank
{
    ...
    public static function getOrgDetailListing() {
        return ['AHRQ' => 'Agency for Healthcare Research and Quality',
...
//		                         </option>';
        ...
        $classification_html .= '<option 
                                    ...
                                    data-content="<span style=\'padding-left: 20px; font-style: italic;\' class=\'fs14\' title=\''.$lang['design_928'].'\'><img src=\''.APP_PATH_IMAGES.'plus.png\'> '.$lang['design_930'].'</span>  <span class=\'badge badge-light\'>'.count($classificationArr).'</span><span class=\'text-secondary fs11 ml-4\' style=\'\'>'.$lang['design_936'].'</span>">
                                 </option>';
