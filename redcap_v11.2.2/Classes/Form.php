...
class Form
{
	...
	public static function getActionTags($onlineDesigner=false)
	{
		...
		$action_tags['@CALCDATE'] = $lang['design_836'];
		$action_tags['@CALCTEXT'] = $lang['design_837'];
	...
	public static function getMaxChoiceReached($field="", $currentEventId="", $tag="@MAXCHOICE")
	{
		...
		if ($tag == "@MAXCHOICE") {
			...
			$sql = "select value, count(*) as saved from (
                        select distinct record, event_id, field_name, instance, value from redcap_data 
			...
			$sql = "select value, count(*) as saved from (
                        ...
                        from redcap_data d, redcap_surveys_participants p, redcap_surveys_response r
	...
	public static function getFieldDropdownOptions($removeCheckboxFields=false, $includeMultipleChoiceFieldsOnly=false, $includeDAGoption=false, 
												   ...
												   $addFormLabelDividers=true, $alsoIncludeRecordIdField=false, $limitToFieldType=null, $overrideBlankOptionText=null)
	{
		global $Proj, $lang;
		$rc_fields = array();
