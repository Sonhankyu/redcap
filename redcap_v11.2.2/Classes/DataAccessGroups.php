...
class DataAccessGroups
{
			...
			switch ($_GET['action']) {
				case "delete":
					...
					if ($numRecordsInDag == 0 && $gcount + $gcount2 == 0) {
						...
						$sql = "delete from redcap_data_access_groups where group_id = " . $_POST['item'];
						$q = db_query($sql);
	...
	public static function renderDataAccessGroupsTable()
	{
        ...
        $buttons = RCView::div(array('style'=>'text-align:right; font-size:12px;font-weight:normal;max-width:900px; '),
                RCView::button(array('onclick'=>"showBtnDropdownList(this,event,'downloadUploadUsersDagsDropdownDiv');", 'class'=>'jqbuttonmed'),
                    RCView::img(array('src'=>'xls.gif', 'style'=>'vertical-align:middle;position:relative;top:-1px;')) .
                    RCView::span(array('style'=>'vertical-align:middle;'), $lang['data_access_groups_26']) .
