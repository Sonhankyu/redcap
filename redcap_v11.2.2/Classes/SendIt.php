	...
	public static function renderUploadPage()
	{
		...
		if ($fileLocation != 1) {
			...
			if ($fileLocation == 2) { //file repository
				...
				if (!SUPER_USER) {
					$sql = "select 1 from redcap_edocs_metadata d, redcap_user_rights u, redcap_metadata m, redcap_data e 
					...
					$sql = "select 1 from redcap_edocs_metadata d, redcap_metadata m, redcap_data e  
