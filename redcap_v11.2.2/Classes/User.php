...
class User
{
	...
	public static function getUsersDataResRespond($appendFirstLastName=true, $excludeUserID=null)
	{
	...
	public static function getCsvDelimiter()
	{
		...
		return (isset($csv_delimiter) && $csv_delimiter != '' ? $csv_delimiter : (isset($default_csv_delimiter) && $default_csv_delimiter != '' ? $default_csv_delimiter : ","));
	}
