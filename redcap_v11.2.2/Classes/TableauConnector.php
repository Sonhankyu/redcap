                ...
                <div class="boldish mt-3" style="background-color:#f5f5f5;padding:8px;border:1px solid #ccc;">
                    <ol>
                        ...
                        <li style="padding-bottom: 8px;">'.$lang['data_export_tool_260'].'<br>
                            ...
                            <button class="btn btn-primaryrc btn-xs btn-clipboard ml-1 fs12" onclick="copyUrlToClipboard(this); return false;" title="'.js_escape2($lang['global_137']).'" data-clipboard-target="#wdc-url" style="margin-top: 8px;padding:3px 8px 3px 6px;"><i class="fas fa-paste"></i> '.$lang['global_137'].'</button>
                        </li>
