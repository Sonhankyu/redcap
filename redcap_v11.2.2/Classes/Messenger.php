...
class Messenger
{
  ...
  public static function renderMessenger(){
    ...
    if ($user_messaging_enabled)
	{
      ...
      $html = "<div class='message-center-container ".$open_class."' data_open='".$_SESSION["mc_open"]."' style='".(isset($_SESSION["message_center_container_height"]) ? "height:".$_SESSION["message_center_container_height"] : "")."'>
