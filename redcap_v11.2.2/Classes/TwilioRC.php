...
class TwilioRC
{
	...
	public static function promptSurveyCode($voiceCall=true, $respondentPhoneNumber=null, $twilioPhoneNumber=null)
	{
		global $lang;
		...
		if ($voiceCall) {
			...
			// Send SMS
			$smsSuccess = self::sendSMS($lang['survey_619']." ".$lang['survey_1308'], $respondentPhoneNumber, $twilioClient, $twilioPhoneNumber);
			if ($smsSuccess !== true) {
				// Error sending SMS
			}
		}
