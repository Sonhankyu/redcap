...
class NIHQuestionLibrary extends FieldBank
{
    ...
    private $utsApiKey = "1f1c6d1a-b536-405c-bb48-f5e0f1485416";
    ...
    public function search($keyword, $org="", $page_num = 1)
    {
        ...
        $this->apiSearchParams["searchToken"] = session_id();
        // API request
    ...
    public function generateTGIApiUrl($generate_new = false) {
        ...
        $tgtApiParam['apikey'] = $this->utsApiKey;
        ...
        if (!isset($_COOKIE['tgi_api_url']) || $generate_new == true) {
            ...
            if ($doc->loadHtml($responseHTML)) {
                ...
                setcookie('tgi_api_url', $form->getAttribute('action'), time()+(60*60*8));
