...
vendor/bin/phpcs -ps --runtime-set testVersion 7.0- --standard=vendor/phpcompatibility/php-compatibility/PHPCompatibility --extensions=php --ignore=/tests,/vendor .
