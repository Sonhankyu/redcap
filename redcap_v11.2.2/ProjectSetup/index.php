...
if(UserRights::isSuperUserNotImpersonator() && DataMart::isEnabled($project_id))
{
						...
						<fieldset class='yellow' data-test='".$super_user."'>
							...
							<div style='padding:0 5px 5px 15px;color:#A00000;'>
								...
								<div style='text-indent:-18px;margin-left:18px;margin-top:5px;'>
									...
									<span style='cursor:pointer;' onclick=\"$('#delete_data').prop('checked',true);\">{$lang['edit_project_217']}</span>
								</div>
							</div>
						</fieldset>
