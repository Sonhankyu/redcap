...
class MetaDataTest extends TestCase
{
	...
	public static function create($project_id, $field_name='record_id', $field_order=1)
	{
		$sql = "
	...
	public function testGetDateFormatDisplay()
	{
		...
		foreach($a as $k => $v)
		{
			foreach($v as $vv)
			{
				$this->assertEquals($k, MetaData::getDateFormatDisplay($vv));
			}
		}
	}
	...
	public function testGetFields()
	{
		...
		$fields = MetaData::getFields($project_id, false, $field_name, false, false, $field_names);
	...
	*/
	...
	{
		clearTable('redcap_metadata');
		$this->assertEquals(0, rowCount('redcap_metadata'));
	}
}
