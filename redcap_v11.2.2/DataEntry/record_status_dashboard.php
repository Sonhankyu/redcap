...
//            end($rec_attr[$attr['event_id']]);
//            $key = key($rec_attr[$attr['event_id']]);
            if(!strpos($this_record, "--") && array_key_last($rec_attr[$attr['event_id']]) == $attr['form_name'] && end($rec_attr[$attr['event_id']]) == null){
