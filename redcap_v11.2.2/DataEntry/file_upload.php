...
if (isset($_POST['myfile_base64']) && $_POST['myfile_base64'] != '') {
	...
	$_FILES['myfile']['tmp_name'] = APP_PATH_TEMP . "signature_pid{$project_id}_" . date('Y-m-d_His_') . substr(sha1(mt_rand()), 0, 12) . ".png";
...
$inlineActionTagJS = (strpos($Proj->metadata[$field_name]['misc'], '@INLINE') !== false) ? "window.parent.window.$(function(){ window.parent.window.initInlineImages('$field_name'); });" : "";
