...
{{loadJS('glass-breaker/dist/glass_breaker_vue.umd.min.js')}}
<link rel="stylesheet" href="{{$objHtmlPage->CacheBuster($app_path_js.'glass-breaker/dist/glass_breaker_vue.css')}}">
<script>
