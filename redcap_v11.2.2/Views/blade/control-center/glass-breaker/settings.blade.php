			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="javascript:;" class="cclink password-mask-reveal" style="text-decoration:underline;font-size:7pt;margin-left:5px;" onclick="$(this).remove();showPasswordField('fhir_break_the_glass_token_password');">Show password</a>
					</td>
				</tr>
			</tbody>
		</table>
