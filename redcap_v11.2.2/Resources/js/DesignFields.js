...
function deleteField(this_field,section_header) {
	if (section_header) {
		...
		simpleDialog(delFieldMsg+' "<b>'+this_field+'</b>"'+langQuestionMark,delFieldTitle,null,null,null,langCancel,"deleteFieldDo('"+this_field+"',"+section_header+");",langOD24);
	}
}
...
function deleteFieldDo(this_field,section_header) {
	...
	for (i = 0; i < fields.length; i++) {
		...
		$.get(app_path_webroot + "Design/delete_field.php", {
				pid: pid,
