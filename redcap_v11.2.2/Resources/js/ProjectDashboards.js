...
function updateDashboardPanel(folder_id, collapsed) {
    ...
    $.post(app_path_webroot+'index.php?pid='+pid+'&route=ProjectDashController:viewpanel', { collapse: collapse }, function(data){
...
function addFieldWizard()
{
    ...
    if (!lastFieldDD.find('.fas').length) {
        $('.smart-thing-fields:last').after('<a href="javascript:;" class="ml-2 mt-1 text-danger" title="'+lang.dash_106+'" onclick="removeFieldWizard(this);"><i class="fas fa-times fs16"></i></a>')
    }
