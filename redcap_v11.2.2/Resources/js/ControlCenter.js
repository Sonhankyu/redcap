...
function disableAllFormElements()
{
	...
	$('#control_center_window h4:first').append("<span class='browseProjPid fs12 font-weight-normal ml-3'>"+lang.control_center_4751+"</span>");
	$('#control_center_window h4:first').after("<div class='text-danger my-3'><i class=\"fas fa-exclamation-circle\"></i> "+lang.control_center_4754+"</div>");
}
