...
function dialogReevalAlerts() {
    ...
    $.post(app_path_webroot+'index.php?route=AlertsController:reevalAlerts&action=view&pid='+pid, { }, function(data){
        ...
        simpleDialog(data,lang.alerts_252,'reeval_alert_dlg',700, null, langCancel , 'saveReevalAlerts();', lang.alerts_251);
    });
}
...
function saveReevalAlerts() {
    ...
    showProgress(1);
    $.post(app_path_webroot+'index.php?route=AlertsController:reevalAlerts&action=save&pid='+pid, { alert_ids: se.join(',') }, function(data){
        showProgress(0,0);
        if (data == '0') {
            alert(woops);
            return false;
