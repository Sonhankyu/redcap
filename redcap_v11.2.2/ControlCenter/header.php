...
<div class="row">
	...
	<div id="control_center_menu" class="d-none d-md-block col-md-4 col-lg-3" role="navigation">
		...
		<div class="cc_menu_section">
			...
			<?php } ?>
			<div class="cc_menu_item"><i class="fas fa-user-shield"></i> <a href="<?php echo APP_PATH_WEBROOT ?>ControlCenter/superusers.php"><?php echo $lang['control_center_4734'] ?></a><?php if (!ADMIN_RIGHTS) { print "<span class='browseProjPid fs10 ml-1'>{$lang['control_center_4751']}</span>"; } ?></div>
		</div>
		<?php } ?>
		...
		<div class="cc_menu_section">
			...
			<?php if (defined("APP_URL_EXTMOD_RELATIVE")) { ?>
				<div class="cc_menu_item"><i class="fas fa-cube fs14" style="margin-left:2px;margin-right:2px;"></i>&nbsp;<a href="<?=APP_URL_EXTMOD_RELATIVE?>manager/control_center.php"><?php echo $lang['global_142'] ?></a><?php if (!ACCESS_EXTERNAL_MODULE_INSTALL) { print "<span class='browseProjPid fs10 ml-1'>{$lang['control_center_4751']}</span>"; } ?></div>
			<?php } ?>
			...
			<?php if (ACCESS_ADMIN_DASHBOARDS) { ?><div class="cc_menu_item"><i class="fas fa-database" style="margin-left:2px;margin-right:2px;"></i>&nbsp; <a href="<?php echo APP_PATH_WEBROOT ?>ControlCenter/mysql_dashboard.php"><?php echo $lang['control_center_4457'] ?></a></div><?php } ?>
		</div>
		
		<!-- Misc modules -->
        <div class="cc_menu_divider"></div>
		<div class="cc_menu_section">
          <div class="cc_menu_header"><?php echo $lang['control_center_4399'] ?><?php if (!ACCESS_SYSTEM_CONFIG) { print "<span class='browseProjPid fs10 ml-2 font-weight-normal'>{$lang['control_center_4751']}</span>"; } ?></div>
        ...
        <div class="cc_menu_divider"></div>
		<div class="cc_menu_section">
			<div class="cc_menu_header"><?php echo $lang['control_center_131'] ?><?php if (!ACCESS_SYSTEM_CONFIG) { print "<span class='browseProjPid fs10 ml-2 font-weight-normal'>{$lang['control_center_4751']}</span>"; } ?></div>
