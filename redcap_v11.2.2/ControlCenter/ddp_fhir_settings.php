...
<div style="font-size:18px;">
	<h4 class="float-left fs18" style="margin-top:10px;"><i class="fas fa-fire"></i> <?php echo $lang['ws_262'] ?></h4>
...
<tr>
    <td class="cc_data" style="padding-top:2px;" colspan="2">
        <div class="boldish" style="color:#C00000;">
            ...
            <button type="button" class="btn btn-xs btn-rcred ml-2" onclick="simpleDialog(null,null,'cdis-diff',1000);fitDialog($('#cdis-diff'));return false;"><?php echo $lang['global_84'] ?></button>
        </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul>
                                ...
                                <li>Project-level settings control whether or not users in the project can 1) fetch data just one time or as often as they wish,
                                    2) modify the data pull configuration or not and 3) if new data is pulled automatically with a cron job once a day. These settings may be changed only by a REDCap administrator.</li>
                            </ul>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul>
                                <li>Data Mart will pull data from the EHR when a user with appropriate privileges clicks the "Fetch clinical data" button.
                                    Also a cron job may be set from the Project-level settings control to pull any new data once a day automatically.</li>
