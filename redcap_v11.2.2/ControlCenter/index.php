...
if (!System::isOnRecommendedPhpVersion()) {
	$phpVersionWarningTextContent = $lang['control_center_4723']." ".implode(", ", System::$recommendedPhpVersions).$lang['period']." ";
	if (version_compare(PHP_VERSION, (max(System::$recommendedPhpVersions).".999"), '>')) {
	...
	$phpVersionWarningText = "<a href='javascript:;' data-toggle=\"popover\" data-content=\"".js_escape2($phpVersionWarningTextContent)."\" data-placement=\"bottom\" data-trigger=\"hover\"><i class=\"fas fa-exclamation-triangle text-danger ml-1\"></i></a>";
}
?>
...
<h4 class="clearfix mt-0 mb-3">
    ...
    <div class="float-right fs13 mt-1">
        <span class="mr-2"><?php echo $lang['control_center_4722'] ?></span>
        <code class="boldish fs13">REDCap <?=REDCAP_VERSION?> &middot; PHP <?=PHP_VERSION.$phpVersionWarningText?> (<?=$server_type?>) &middot; <?=db_get_server_type()." ".db_get_version(true)?></code>
    </div>
</h4>
<p>
