...
$row_data[] = array("$indent1 {$lang['dashboard_38']}", '<span id="total_records"><a href="javascript:;" style="text-decoration:underline;font-size:11px;" onclick="getTotalRecordCount()">'.$lang['rights_280'].'</a></span>');
