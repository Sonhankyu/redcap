...
<tr>
    ...
    <td class="cc_data">
        <input class='x-form-text x-form-field' style="width:80px;" type='text' name='project_dashboard_min_data_points' value='<?php echo htmlspecialchars($element_data['project_dashboard_min_data_points'], ENT_QUOTES) ?>' onblur="redcap_validate(this,'1','999999999','soft_typed','int')" />
        <div class="cc_info">
