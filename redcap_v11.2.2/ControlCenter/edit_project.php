...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	foreach ($_POST as $field=>$value) {
	    if ($value == "" && in_array($field, Project::$overwritableGlobalVars)) {
	        $value = "NULL";
        }
...
if (isset($_GET['project'])) {
	...
	if ($GLOBALS['auth_meth_global'] != "none" && $element_data['auth_meth'] == "none") {
		$element_data['auth_meth'] = $GLOBALS['auth_meth_global'];
	}
}
?>
...
if (isset($_GET['project']) && is_numeric($_GET['project']))
{
	...
	<tr  id="auth_meth-tr" sq_id="auth_meth">
		...
		<td class="cc_data">
			<select class="x-form-text x-form-field" style="" name="auth_meth">
				<?php if ($GLOBALS['auth_meth_global'] == "none") { ?><option value='none' <?php echo ($element_data['auth_meth'] == "none" ? "selected" : "") ?>><?php echo $lang['system_config_08'] ?></option><?php } ?>
				...
				<option value='oauth2_azure_ad' <?php echo ($element_data['auth_meth'] == "oauth2_azure_ad" ? "selected" : "") ?>>Azure AD OAuth2 <?php echo $lang['system_config_251'] ?></option>
    ...
    <tr  id="dts_enabled-tr">
        ...
        <td class="cc_data">
            <?php $disabled = (!$fhir_include_email_address) ? "disabled" : ""; ?>
	...
	<tr>
		<td class="cc_label" colspan="2">
			...
			<textarea class='x-form-field notesbox mceEditor' style="height:250px;" id='custom_index_page_note' name='custom_index_page_note'><?php echo RCView::escape($element_data['custom_index_page_note']) ?></textarea>
	...
	<tr>
        <td class="cc_label pb-5" colspan="2">
			...
			<textarea class='x-form-field notesbox mceEditor' style="height:250px;" id='custom_data_entry_note' name='custom_data_entry_note'><?php echo RCView::escape($element_data['custom_data_entry_note']) ?></textarea>
    ...
    <tr>
        <td class="cc_label">
            <?php echo $lang['dash_113'] ?>
        </td>
        <td class="cc_data">
            <input class='x-form-text x-form-field ' type='text' name='project_dashboard_min_data_points' value='<?php echo htmlspecialchars($element_data['project_dashboard_min_data_points'], ENT_QUOTES) ?>' onblur="redcap_validate(this,'1','999999999','soft_typed','int')" /><br/>
