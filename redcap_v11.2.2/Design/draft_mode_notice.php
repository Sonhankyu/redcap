...
elseif ($draft_mode == 0 && $status > 0)
{
	if ($status == 1) {
		...
		print  "<div class='yellow' style='max-width:850px;'>
		...
		// Inactive
		print  "<div class='yellow mt-3' style='max-width:850px;'>
...
} elseif ($draft_mode == 2 && $status > 0)
{
	...
	if (UserRights::isSuperUserNotImpersonator()) {
		print  "<div class='red' style='margin:20px 0;padding-bottom:15px;max-width:850px;'>
	...
	// Display message
	print  "<div class='yellow' style='padding:10px;max-width:850px;'>
